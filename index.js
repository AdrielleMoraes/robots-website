...
mongoose.connect("mongodb+srv://" + process.env.MONGODB_USER + ":" + process.env.MONGODB_PASSWORD + "@" + process.env.MONGODB_CLUSTERNAME + ".scndl.mongodb.net/cluster0?retryWrites=true&w=majority", { 
